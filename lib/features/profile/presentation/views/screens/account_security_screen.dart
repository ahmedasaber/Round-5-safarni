        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: _isProcessingDelete ? null : () => Navigator.pop(context),
            ),
            title: Text('Account & Security', style: TextStyles.font18DarkBlackNormal),
            centerTitle: true,
          ),
                ...
                child: Column(
                  children: [
                    ...
                    BuildToggleItem(
                      ...
                      onChanged: _isProcessingDelete ? null : (value) {
                    ...
                    BuildNavigationItem(
                      ...
                      subtitle: 'Permanently remove your account and data from Tripmate. Proceed with caution.',
                      titleColor: Colors.red,
                      onTap: _isProcessingDelete ? () {} : _showDeleteAccountDialog,
                    ),
                  ],
                ),
              );
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: TextButton(
                          onPressed: _isProcessingDelete ? null : () {
                      ...
                      Expanded(
                        child: BlocConsumer<ProfileCubit, ProfileState>(
                          listener: (context, state) {
                            if ((state is ProfileError || state is ProfileAccountDeleted) &&
                          ...
                          builder: (context, state) {
                            ...
                            return TextButton(
                              onPressed: (isLoading || _isProcessingDelete) ? null : () {
                                _showFinalConfirmationDialog(dialogContext);
                              },
                              style: TextButton.styleFrom(
                                padding: const EdgeInsets.symmetric(vertical: 12),
                                backgroundColor: Colors.red,
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: TextButton(
                          onPressed: _isProcessingDelete ? null : () {
                            if (Navigator.of(finalDialogContext).canPop()) {
                      ...
                      Expanded(
                        child: BlocConsumer<ProfileCubit, ProfileState>(
                          listener: (context, state) {
                            if ((state is ProfileAccountDeleted || state is ProfileError) &&
