...
class AvailableToursRemoteDataSourceImpl extends AvailableToursRemoteDataSource{
  ...
  AvailableToursRemoteDataSourceImpl({required this.favoriteLocalDataSource, required this.dio});
  @override
  Future<List<TourModel>> fetchAvailableTours() async{
    try {
      ...
      if(response.statusCode == 200){
        ...
        List<TourModel> toursList = data.map((availableTour)=> TourModel.fromJson(availableTour)).toList();
