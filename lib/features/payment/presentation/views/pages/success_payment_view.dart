...
import 'package:safarni/core/common/widgets/appbar.dart';
      ...
      body: Center(
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                const SizedBox(height: TextStyles.spaceBtwSections - 10,),
                Image(
                ...
                AppElevatedButton(buttonTitle: "Back to Home",primaryButton: true,onPressed: (){Navigator.of(context).pushReplacementNamed(HomeView.routeName);},)
              ],
            ),
          ),
        ),
